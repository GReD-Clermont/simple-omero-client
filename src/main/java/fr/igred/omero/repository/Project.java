...
public interface Project extends RepositoryObject, ContainerLinked {
     ...
     */
    @Override
    default List<? extends Project> getProjects(Client client)
     ...
     */
    List<? extends Dataset> getDatasets(String name);
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    List<? extends Image> getImages(Client client, String datasetName, String imageName)
    throws ServiceException, AccessException, ExecutionException;
