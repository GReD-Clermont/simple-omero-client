...
public abstract class AnnotatableWrapper<T extends DataObject> extends ObjectWrapper<T> {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void linkIfNotLinked(DataManager client, AnnotationWrapper<?>... annotations)
    throws ServiceException, AccessException, ExecutionException {
     ...
     */
    public void rate(DataManager client, int rating)
     ...
     * @throws InterruptedException The thread was interrupted.
     */
    public void addAndReplaceTable(DataManager client, TableWrapper table, ReplacePolicy policy)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
        String error = "Cannot add table to " + this;
     ...
     * @throws InterruptedException The thread was interrupted.
     */
    public void addAndReplaceTable(DataManager client, TableWrapper table)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
     ...
     * @throws InterruptedException The thread was interrupted.
     */
    public long addAndReplaceFile(DataManager client, File file, ReplacePolicy policy)
     ...
     * @throws InterruptedException The thread was interrupted.
     */
    public long addAndReplaceFile(DataManager client, File file)
    throws ExecutionException, InterruptedException, AccessException, ServiceException {
     ...
     */
    public <A extends AnnotationWrapper<?>> void unlink(DataManager client, A annotation)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    public <A extends AnnotationWrapper<?>> void unlink(DataManager client, Collection<A> annotations)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
        removeLinks(client,
                    annotationLinkType(),
                    annotations.stream()
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    protected void removeLinks(DataManager client, String linkType, Collection<Long> childIds)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    protected void removeLink(DataManager client, String linkType, long childId)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void copyAnnotationLinks(DataManager client, AnnotatableWrapper<?> object)
    throws AccessException, ServiceException, ExecutionException {
