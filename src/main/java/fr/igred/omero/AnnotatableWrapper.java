...
public abstract class AnnotatableWrapper<T extends DataObject> extends ObjectWrapper<T> {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    protected <A extends AnnotationData> void link(ConnectionHandler client, A annotation)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public <A extends AnnotationWrapper<?>> void link(ConnectionHandler client, A annotation)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void link(ConnectionHandler client, AnnotationWrapper<?>... annotations)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void linkIfNotLinked(ConnectionHandler client, AnnotationWrapper<?>... annotations)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void addTag(ConnectionHandler client, String name, String description)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void addTag(ConnectionHandler client, Long id)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void addTags(ConnectionHandler client, Long... ids)
    throws ServiceException, AccessException, ExecutionException {
        for (Long id : ids) {
            addTag(client, id);
        }
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void addKeyValuePair(ConnectionHandler client, String key, String value)
    throws ServiceException, AccessException, ExecutionException {
     ...
     */
    public void rate(ConnectionHandler client, int rating)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void addTable(ConnectionHandler client, TableWrapper table)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws InterruptedException The thread was interrupted.
     */
    public void addAndReplaceTable(ConnectionHandler client, TableWrapper table, ReplacePolicy policy)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
        String error = "Cannot add table to " + this;
     ...
     * @throws InterruptedException The thread was interrupted.
     */
    public void addAndReplaceTable(ConnectionHandler client, TableWrapper table)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public TableWrapper getTable(ConnectionHandler client, Long fileId)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public List<TableWrapper> getTables(ConnectionHandler client)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws InterruptedException The thread was interrupted.
     */
    public long addFile(ConnectionHandler client, File file)
     ...
     * @throws InterruptedException The thread was interrupted.
     */
    public long addAndReplaceFile(ConnectionHandler client, File file, ReplacePolicy policy)
     ...
     * @throws InterruptedException The thread was interrupted.
     */
    public long addAndReplaceFile(ConnectionHandler client, File file)
    throws ExecutionException, InterruptedException, AccessException, ServiceException {
     ...
     */
    public <A extends AnnotationWrapper<?>> void unlink(ConnectionHandler client, A annotation)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    public <A extends AnnotationWrapper<?>> void unlink(ConnectionHandler client, Collection<A> annotations)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
        removeLinks(client,
                    annotationLinkType(),
                    annotations.stream()
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    protected void removeLinks(ConnectionHandler client, String linkType, Collection<Long> childIds)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    protected void removeLink(ConnectionHandler client, String linkType, long childId)
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void copyAnnotationLinks(ConnectionHandler client, AnnotatableWrapper<?> object)
    throws AccessException, ServiceException, ExecutionException {
