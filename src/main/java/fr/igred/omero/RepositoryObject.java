 ...
 */
public abstract class RepositoryObject<T extends DataObject> extends Annotatable<T> {

    /**
     * Constructor of the class RepositoryObject.
     *
     * @param o The DataObject to wrap in the RepositoryObject.
     */
    protected RepositoryObject(T o) {
        super(o);
    }
