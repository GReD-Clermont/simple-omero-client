 ...
 */
public class ROI extends Annotatable<ROIData> {
     ...
     * @return The converted list of OMERO ROIs.
     */
    private static List<ROI> fromImageJ(List<? extends ij.gui.Roi> ijRois,
                                        String property,
                                        Supplier<? extends ROI> constructor,
                                        Function<? super ij.gui.Roi, ? extends List<? extends Shape<?>>> converter) {
        property = checkProperty(property);
     ...
     * @return The converted list of ImageJ ROIs.
     */
    public static List<ij.gui.Roi> toImageJ(Collection<? extends ROI> rois, String property, boolean groupRois) {
        property = checkProperty(property);
