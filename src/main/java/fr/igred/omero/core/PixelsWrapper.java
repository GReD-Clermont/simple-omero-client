...
public class PixelsWrapper extends ObjectWrapper<PixelsData> {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    boolean createRawDataFacility(AdminManager client) throws ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public double[][][][][] getAllPixels(AdminManager client)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    double[][] getTile(AdminManager client, Coordinates start, int width, int height)
    throws AccessException, ExecutionException {
        boolean rdf = createRawDataFacility(client);
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public byte[][][][] getRawPixels(AdminManager client, int bpp)
    throws AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public byte[][][][] getRawPixels(AdminManager client,
                                     int[] xBounds,
                                     int[] yBounds,
                                     int[] cBounds,
                                     int[] zBounds,
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    byte[] getRawTile(AdminManager client, Coordinates start, int width, int height, int bpp)
    throws AccessException, ExecutionException {
        boolean rdf = createRawDataFacility(client);
