...
public class ImageWrapper extends RepositoryObjectWrapper<ImageData> {
     ...
     */
    private byte[] getThumbnailBytes(AdminManager client, int size)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public List<ROIWrapper> saveROIs(AdminManager client, Collection<? extends ROIWrapper> rois)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public List<ROIWrapper> saveROIs(AdminManager client, ROIWrapper... rois)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public List<ROIWrapper> getROIs(AdminManager client)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public List<FolderWrapper> getROIFolders(AdminManager client)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public ImagePlus toImagePlus(AdminManager client)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public ImagePlus toImagePlus(AdminManager client, ROIWrapper roi)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public ImagePlus toImagePlus(AdminManager client, Bounds bounds)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public Color getChannelColor(AdminManager client, int index)
    throws ServiceException, AccessException, ExecutionException {
     ...
     */
    public BufferedImage getThumbnail(AdminManager client, int size)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public List<File> download(AdminManager client, String path)
    throws ServiceException, AccessException, ExecutionException {
