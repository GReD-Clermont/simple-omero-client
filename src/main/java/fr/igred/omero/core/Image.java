 ...
 */
public class Image extends RepositoryObject<ImageData> {
     ...
     *
     * @param image The image to wrap in the Image.
     */
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public List<ROI> saveROIs(DataManager dm, ROI... rois)
    throws ServiceException, AccessException, ExecutionException {
    ...
    throws ServiceException, AccessException, ExecutionException {
        ...
        return wrap(folders, Folder::new);
    }
    ...
    public Pixels getPixels() {
        return new Pixels(data.getDefaultPixels());
    }
