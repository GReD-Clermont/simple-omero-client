 ...
 */
public abstract class Annotatable<T extends DataObject> extends RemoteObject<T> {

    /**
     * Constructor of the class RepositoryObject.
     *
     * @param o The annotatable DataObject to wrap in the RepositoryObject.
     */
    protected Annotatable(T o) {
        super(o);
    }
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void link(DataManager dm, Annotation<?>... annotations)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void linkIfNotLinked(Client client, Annotation<?>... annotations)
    throws ServiceException, AccessException, ExecutionException {
    ...
    throws ServiceException, AccessException, ExecutionException {
        TagAnnotation tag = new TagAnnotation(new TagAnnotationData(name));
    ...
    throws ServiceException, AccessException, ExecutionException {
        MapAnnotation pkv = new MapAnnotation(key, value);
        link(dm, pkv);
    }
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    private List<RatingAnnotation> getRatings(Browser browser, List<Long> userIds)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public List<RatingAnnotation> getRatings(Browser browser)
    throws ServiceException, AccessException, ExecutionException {
    ...
    throws ServiceException, AccessException, ExecutionException, InterruptedException {
        ...
        if (ratings.isEmpty()) {
            RatingAnnotation rate = new RatingAnnotation(rating);
            link(client, rate);
        } else {
            int n = ratings.size();
            if (n > 1) {
