...
/**
 * DataManager interface to connect to OMERO, browse through all the data accessible to the user and modify it.
 */
public interface DataManager extends Browser {
    ...
    /**
     * Returns a DataManager associated with the provided username.
     * <p>The user calling this function needs to have administrator rights.
     * <p>All actions realized with the returned DataManager will be considered as his.
     *
     ...
     */
    DataManager sudo(String username)
    throws ServiceException, AccessException, ExecutionException;
