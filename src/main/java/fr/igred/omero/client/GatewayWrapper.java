 ...
 */
public class GatewayWrapper extends BrowserWrapper implements AdminManager {
    ...
    private void closeImportStoreLocked() {
        if (storeLock.tryLock()) {
            try {
                AdminManager.super.closeImport();
            } finally {
                storeLock.unlock();
            }
        }
    ...
    /**
     * Returns a AdminManager associated with the given username.
     ...
     */
    @Override
    public AdminManager sudo(String username)
