 ...
 */
public class GatewayWrapper extends BrowserWrapper implements DataManager {
    ...
    /**
     * Returns a DataManager associated with the given username.
     ...
     */
    @Override
    public DataManager sudo(String username)
