...
public abstract class RemoteObject<T extends DataObject> {
     ...
     *
     * @param o The DataObject to wrap in the RemoteObject.
     */
    protected RemoteObject(T o) {
        this.data = o;
    }


    /**
     * Converts a DataObject list to an RemoteObject list, sorted by {@code sorter}.
     *
     ...
     * @return Distinct objects list, sorted by ID.
     */
    public static <U extends RemoteObject<?>>
