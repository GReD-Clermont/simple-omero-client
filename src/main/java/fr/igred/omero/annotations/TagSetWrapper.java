...
public class TagSetWrapper extends TagAnnotationWrapper {
     ...
     */
    public TagSetWrapper(GatewayWrapper dm, String name, String description)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void link(GatewayWrapper dm, TagAnnotationWrapper tag)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void link(GatewayWrapper dm, TagAnnotationWrapper... tags)
    throws AccessException, ServiceException, ExecutionException {
