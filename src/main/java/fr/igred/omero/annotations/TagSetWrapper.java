...
public class TagSetWrapper extends TagAnnotationWrapper {
     ...
     */
    public TagSetWrapper(ConnectionHandler dm, String name, String description)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void link(ConnectionHandler dm, TagAnnotationWrapper tag)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void link(ConnectionHandler dm, TagAnnotationWrapper... tags)
    throws AccessException, ServiceException, ExecutionException {
