 ...
 */
public class TextualAnnotation extends Annotation<TextualAnnotationData> {

    /**
     * Constructor of the TextualAnnotation class.
     *
     * @param object TextualAnnotationData to be wrap.
     */
    public TextualAnnotation(TextualAnnotationData object) {
        super(object);
    }
     ...
     */
    public TextualAnnotation(String text) {
