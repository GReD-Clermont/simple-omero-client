 ...
 */
public class RatingAnnotation extends Annotation<RatingAnnotationData> {
    ...
    /**
     * Constructor of the RatingAnnotation class.
     *
     * @param object RatingAnnotationData to wrap.
     */
    public RatingAnnotation(RatingAnnotationData object) {
        super(object);
    }
     ...
     */
    public RatingAnnotation(int value) {
