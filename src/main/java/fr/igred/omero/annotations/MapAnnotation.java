...
public class MapAnnotation extends Annotation<MapAnnotationData> {
     ...
     */
    public MapAnnotation(MapAnnotationData data) {
        super(data);
    }


    /**
     * Constructor of the MapAnnotation class. Sets the content of the map annotation.
     *
     * @param pairs Collection of Key-Value pairs.
     */
    public MapAnnotation(Collection<? extends Entry<String, String>> pairs) {
    ...
    /**
     * Constructor of the MapAnnotation class. Sets the content to a single key-value pair.
     * <p>Initializes the namespace to {@link #NS_USER_CREATED}.</p>
     *
     * @param key   The key.
     * @param value The value.
     */
    public MapAnnotation(String key, String value) {
    ...
    public void setContent(Collection<? extends Entry<String, String>> pairs) {
        List<NamedValue> nv = pairs.stream()
                                   .map(MapAnnotation::toNamedValue)
                                   .collect(toList());
        data.setContent(nv);
    }
