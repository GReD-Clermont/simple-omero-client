...
public class TagAnnotation extends Annotation<TagAnnotationData> {
     ...
     */
    public TagAnnotation(TagAnnotationData tag) {
        super(tag);
    }


    /**
     * Constructor of the TagAnnotation class. Creates the tag and saves it to OMERO.
     *
     ...
     */
    public TagAnnotation(DataManager dm, String name, String description)
