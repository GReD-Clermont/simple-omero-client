 ...
 */
public class TagSet extends TagAnnotation {

    /**
     * Constructor of the TagSet class.
     *
     * @param tag TagAnnotationData to wrap.
     */
    public TagSet(TagAnnotationData tag) {
        super(tag);
    ...
    /**
     * Constructor of the TagSet class. Creates the tag set and saves it to OMERO.
     *
     ...
     */
    public TagSet(DataManager dm, String name, String description)
    ...
    public List<TagAnnotation> getTags() {
        return wrap(data.getTags(), TagAnnotation::new);
    }
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void link(DataManager dm, TagAnnotation tag)
