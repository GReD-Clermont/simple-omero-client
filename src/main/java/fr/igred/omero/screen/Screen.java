...
public class Screen extends RepositoryObject<ScreenData> {
    ...
    /**
     * Constructor of the Screen class. Creates a new screen and saves it to OMERO.
     *
     ...
     */
    public Screen(DataManager dm, String name, String description)
     ...
     *
     * @param screen The ScreenData contained in the Screen.
     */
    public Screen(ScreenData screen) {
        super(screen);
    }
