...
public class FolderWrapper extends RepositoryObjectWrapper<FolderData> {
     ...
     */
    public FolderWrapper(ClientImpl client, String name)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void addImages(ClientImpl client, ImageWrapper... images)
    throws ServiceException, AccessException, ExecutionException {
     ...
     */
    public void addROIs(ClientImpl client, long imageId, ROIWrapper... rois)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException If the ROIFacility can't be retrieved or instantiated.
     */
    public void addROIs(ClientImpl client, ImageWrapper image, ROIWrapper... rois)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public List<ROIWrapper> getROIs(ClientImpl client, long imageId)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public List<ROIWrapper> getROIs(ClientImpl client, ImageWrapper image)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void unlinkAllROIs(ClientImpl client, long imageId)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void unlinkAllROIs(ClientImpl client, ImageWrapper image)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void unlinkAllROIs(ClientImpl client)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void unlinkROIs(ClientImpl client, ROIWrapper... rois)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void unlinkROIs(ClientImpl client, Collection<? extends ROIWrapper> rois)
    throws ServiceException, AccessException, ExecutionException {
