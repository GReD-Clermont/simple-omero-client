...
public class ProjectWrapper extends RepositoryObjectWrapper<ProjectData> {
     ...
     */
    public ProjectWrapper(ConnectionHandler client, String name, String description)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public DatasetWrapper addDataset(ConnectionHandler client, String name, String description)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public DatasetWrapper addDataset(ConnectionHandler client, DatasetWrapper dataset)
    throws ServiceException, AccessException, ExecutionException {
        dataset.saveAndUpdate(client);
     ...
     */
    public void removeDataset(ConnectionHandler client, DatasetWrapper dataset)
