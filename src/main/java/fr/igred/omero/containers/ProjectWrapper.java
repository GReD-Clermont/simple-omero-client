...
public class ProjectWrapper extends RepositoryObjectWrapper<ProjectData> {
     ...
     */
    public ProjectWrapper(GatewayWrapper client, String name, String description)
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public DatasetWrapper addDataset(GatewayWrapper client, String name, String description)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public DatasetWrapper addDataset(GatewayWrapper client, DatasetWrapper dataset)
    throws ServiceException, AccessException, ExecutionException {
        dataset.saveAndUpdate(client);
     ...
     */
    public void removeDataset(GatewayWrapper client, DatasetWrapper dataset)
