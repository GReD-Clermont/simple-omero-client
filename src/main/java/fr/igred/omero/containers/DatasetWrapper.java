...
public class DatasetWrapper extends RepositoryObjectWrapper<DatasetData> {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void addImages(ClientImpl client, Iterable<? extends ImageWrapper> images)
    throws ServiceException, AccessException, ExecutionException {
     ...
     * @throws ExecutionException A Facility can't be retrieved or instantiated.
     */
    public void addImage(ClientImpl client, ImageWrapper image)
    throws ServiceException, AccessException, ExecutionException {
     ...
     */
    public void removeImage(ClientImpl client, ImageWrapper image)
     ...
     */
    public boolean importImages(ClientImpl client, String... paths)
     ...
     * @throws IOException      Cannot read file.
     */
    public boolean importImages(ClientImpl client, int threads, String... paths)
    throws ServiceException, AccessException, IOException {
     ...
     * @throws IOException      Cannot read file.
     */
    public List<Long> importImage(ClientImpl client, String path)
    throws ServiceException, AccessException, IOException {
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    public List<ImageWrapper> replaceImages(ClientImpl client,
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    public List<Long> importAndReplaceImages(ClientImpl client, String path, ReplacePolicy policy)
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    public List<Long> importAndReplaceImages(ClientImpl client, String path)
    throws ServiceException, AccessException, IOException, ExecutionException, InterruptedException {
