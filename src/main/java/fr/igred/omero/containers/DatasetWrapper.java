...
public class DatasetWrapper extends RepositoryObjectWrapper<DatasetData> {
     ...
     */
    public void removeImage(DataManager client, ImageWrapper image)
     ...
     */
    public boolean importImages(DataManager client, String... paths)
     ...
     * @throws IOException      Cannot read file.
     */
    public boolean importImages(DataManager client, int threads, String... paths)
    throws ServiceException, AccessException, IOException {
     ...
     * @throws IOException      Cannot read file.
     */
    public List<Long> importImage(DataManager client, String path)
    throws ServiceException, AccessException, IOException {
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    public List<ImageWrapper> replaceImages(DataManager client,
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    public List<Long> importAndReplaceImages(DataManager client, String path, ReplacePolicy policy)
     ...
     * @throws InterruptedException If block(long) does not return.
     */
    public List<Long> importAndReplaceImages(DataManager client, String path)
    throws ServiceException, AccessException, IOException, ExecutionException, InterruptedException {
