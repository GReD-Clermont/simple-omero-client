...
class ConnectionTest extends BasicTest {
    ...
    void testDisconnect() {
        ...
        AdminManager testRoot = new GatewayWrapper();
        testRoot.disconnect();
    ...
    void testUserConnection() throws ServiceException {
        ...
        AdminManager testUser = new GatewayWrapper();
