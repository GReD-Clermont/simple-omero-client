...
class ConnectionTest extends BasicTest {
    ...
    void testDisconnect() {
        ...
        GatewayWrapper testRoot = new GatewayWrapper();
        testRoot.disconnect();
    ...
    void testUserConnection() throws ServiceException {
        ...
        GatewayWrapper testUser = new GatewayWrapper();
