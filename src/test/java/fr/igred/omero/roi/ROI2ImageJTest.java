...
class ROI2ImageJTest extends BasicTest {
    ...
    void convertArrow() {
        ...
        Line newArrow = roi.getShapes().getElementsOf(Line.class).get(0);
    ...
    void convertLine() {
        ...
        Line newLine = roi.getShapes().getElementsOf(Line.class).get(0);
    ...
    void convertText(int style) {
        ...
        Roi ijRoi = ROI.toImageJ(ROI.fromImageJ(roiList)).get(0);
