...
class ProjectTest extends UserTest {
    ...
    void testCopyAnnotations() throws Exception {
        ...
        Project project2 = new Project(client, p2name, p2desc);
    ...
    void testReplaceAndUnlinkFile() throws Exception {
        ...
        Project project1 = new Project(client, name + "1", desc);
        Project project2 = new Project(client, name + "2", desc);
    ...
    void testReplaceAndDeleteOrphanedFile2() throws Exception {
        ...
        Project project = new Project(client, name, desc);
