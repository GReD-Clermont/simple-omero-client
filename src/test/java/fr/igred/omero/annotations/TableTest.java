...
public class TableTest extends UserTest {
    ...
    public void testCreateTableWithROIsFromIJResults1() throws Exception {
        ...
        TableWrapper table = new TableWrapper(client, results, imageId, ijRois, "ROI_ID");
    ...
    public void testAddRowsFromIJResults() throws Exception {
        ...
        TableWrapper table = new TableWrapper(client, results1, imageId, ijRois, "ROI_ID");
        table.addRows(client, results2, imageId, ijRois, "ROI_ID");
