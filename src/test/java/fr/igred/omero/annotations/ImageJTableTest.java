...
class ImageJTableTest extends UserTest {
    ...
    void testCreateTableWithROIsFromIJResults1() throws Exception {
        ...
        TableBuilder table = new TableBuilder(client, results, IMAGE_ID, ijRois);
    ...
    void testCreateTableWithROIsFromIJResults2() throws Exception {
        ...
        TableBuilder table = new TableBuilder(client, results, IMAGE_ID, ijRois, property);
        image.addTable(client, table);
    ...
    void testCreateTableWithROIsFromIJResults4() throws Exception {
        ...
        TableBuilder table = new TableBuilder(client, results, IMAGE_ID, ijRois, ROI.IJ_PROPERTY);
        image.addTable(client, table);
    ...
    void testCreateTableFromIJResults() throws Exception {
        ...
        List<TableBuilder> tables = image.getTables(client);
        ...
        List<TableBuilder> noTables = image.getTables(client);
    ...
    void testAddRowsFromIJResults() throws Exception {
        ...
        TableBuilder table = new TableBuilder(client, results1, IMAGE_ID, ijRois, ROI.IJ_PROPERTY);
    ...
    void testCreateTableWithROINamesFromIJResults1() throws Exception {
        ...
        table.addRows(client, res2, IMAGE_ID, ijRois);
        image.addTable(client, table);
